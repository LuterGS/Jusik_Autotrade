...
const (
	...
	SIG_C_HOUR, SIG_C_MIN = 14, 02 //MARKET_LOOKUP_MIN // 단타 트레이더를 시작하는 시간
	SIG_D_HOUR, SIG_D_MIN = 15, 10 // 단타 트레이더 종료 및 AI 트레이더 시작하는 시간
	SIG_E_HOUR, SIG_E_MIN = 15, 19 // 장마감 시간

	ONE_JONGMOK_PRICE = 500000 // 한 종목에 투자할 금액수
	TOTAL_JONGMOK_NUM = 6      // 구매할 종목 수

	CUR_TRADE_MARKET = kiwoom.MARKET_KOSPI // 현재 거래할 주식시
