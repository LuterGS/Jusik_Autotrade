...
# 단타할 주식 시장 - 코스피일 경우 "001", 코스닥일 경우 "101", 둘 다 확인할 경우 "000" (str)
TRADE_MARKET = "101"
...
DANTA_END_HOUR = "14"     # "10" ~ "15" 사이어야 합니다. 아닐 시 오류가 날 수 있습니다.
DANTA_END_MIN = "45"      # "00" ~ "59" 사이어야 합니다. 아닐 시 오류가 날 수 있습니다. (HOUR가 "15"일 경우, "00" ~ "19"까지여야 합니다)
